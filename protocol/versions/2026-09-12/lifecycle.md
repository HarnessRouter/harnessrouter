...
| `plugin_schemas` | string[] | when `plugins` is true | The Agent Plugins manifest schemas the server installs; see [Plugins §7](plugins.md#7-discovery) |
