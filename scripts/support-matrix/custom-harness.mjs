...
const BASES = (process.env.BASES || 'codex,claude-code,hermes,pi,dsh,opencode,qwen,gemini,cline,omp,goose,kimi,muse,aider,openhands').split(',');   // every built-in harness, all fifteen
