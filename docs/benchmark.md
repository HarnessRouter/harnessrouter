...
| opencode | deepseek-v4.1-flash | 48 | 37 (77%) | 0.77 | 6738 s | 98 s | 520 | 64 (12%) | 601k | 8.00M | 81k | deepseek | 2 runs the pack could not grade (the task fails its own grader), left out ; served model unreported on 3 of 50 runs (rule 2 unverifiable there) |
...
- Self-hosted CE: opencode, pi and dsh on 0.18.0 (2026-09-18); cline on 0.18.4 (2026-09-19), a release with #209, so that its input tokens are fresh input. An earlier cline pass on 0.18.0 (36 of 50, input reported gross at 18.87M) is set aside.
