...
const NAV_GROUPS: { label: string | null; items: NavItem[] }[] = [
  ...
  { label: 'Build', items: [
    ...
    // The previous nav mark in greyscale (public/brand/nav-harnesses.svg, generated by luminance
    // from the colour mark), stands for the product's core object.
    { href: '/harnesses', img: '/brand/nav-harnesses.svg', label: 'Agent Harnesses' },   // the previous nav mark, as Richard wants it (2026-09-26: the pack's reads too big here)
