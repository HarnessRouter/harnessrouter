      ...
      <div className="page">
        ...
        <form id="hs-form" className="settings-form" onSubmit={(e) => { e.preventDefault(); void save(); }}>
          ...
          <section className="form-section">
            ...
            <div className="field-stack">
              <div className="field"><label htmlFor="hsInstructions">{['codex', 'hermes', 'omp', 'pi', 'opencode', 'dsh', 'qwen', 'cline', 'goose'].includes(base?.id || draft?.base || '') ? 'AGENTS.md' : 'CLAUDE.md'}</label>
