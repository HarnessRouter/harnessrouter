...
export interface OobHarness {
  ...
  status: 'ready' | 'soon';
  backend: 'claude' | 'codex' | 'hermes' | 'pi' | 'dsh' | 'opencode' | 'devin' | null; // gateway backend; null = coming soon
...
export const OOB: OobHarness[] = [
  ...
  { id: 'devin', name: 'Devin', version: 'v1.0.0', backend: 'devin', status: 'ready',
    models: ['devin-swe', 'devin-swe-fast', 'devin-opus', 'devin-sonnet', 'devin-gpt-5.5', 'devin-adaptive'], defaultModel: 'devin-swe', moreModels: 0,
